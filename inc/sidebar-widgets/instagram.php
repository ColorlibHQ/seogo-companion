...
----------------------------------------*/
class seogo_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('seogo_instagram_photo',esc_html__('[ Seogo ] Intagram Photo','seogo-companion'),array(
			'description' => esc_html__('Seogo Instagram Photo Widget','seogo-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'seogo-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'seogo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'seogo-companion'); ?></label>
...
if(!function_exists('seogo_instagram_widgets')):
	function seogo_instagram_widgets(){
		register_widget('seogo_instagram_photo');
	}
	add_action('widgets_init','seogo_instagram_widgets');
endif;
