...
class Seogo_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Seogo ] Social Links', 'seogo-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'seogo-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'seogo-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'seogo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'seogo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'seogo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'seogo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'seogo-companion'); ?></label>
...
} // Class seogo_social_links ends here


// Register and load the widget
function seogo_social_links_widget_load() {
	register_widget( 'Seogo_social_links' );
}
add_action( 'widgets_init', 'seogo_social_links_widget_load' );