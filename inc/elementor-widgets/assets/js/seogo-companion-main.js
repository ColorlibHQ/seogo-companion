(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".seogo-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".seogo-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.seogo-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.seogo-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.seogo-subscribe-newsletter-area');
    if ($subscribe.length) {
