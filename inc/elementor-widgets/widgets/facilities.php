...
/**
 *
 * Seogo elementor facilities section widget.
 *
 * @since 1.0
 */
class Seogo_Facilities extends Widget_Base {

	public function get_name() {
		return 'seogo-facilities';
	}

	public function get_title() {
		return __( 'App Facilities', 'seogo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'facilities_content',
			[
				'label' => __( 'Facilities content', 'seogo-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => 'Save your time to <br>using seogo',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Facilities', 'seogo-companion' ),
            ...
            <div class="row">
                ...
                if( is_array( $facilities ) && count( $facilities ) > 0 ) {
                    foreach( $facilities as $item ) {
                        $item_icon = ( !empty( $item['item_icon'] ) ) ? SEOGO_DIR_ICON_IMG_URI . $item['item_icon'] : '';
