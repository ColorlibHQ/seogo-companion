...
/**
 *
 * Seogo elementor app section widget.
 *
 * @since 1.0
 */
class Seogo_App_Section extends Widget_Base {

	public function get_name() {
		return 'seogo-app-section';
	}

	public function get_title() {
		return __( 'App Section', 'seogo-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'apps_content',
            [
                'label' => __( 'App Section Settings', 'seogo-companion' ),
            ]
        );
        $this->add_control(
            'sec_img',
            [
                ...
                'description' => esc_html__( 'Best size is 1920x456', 'seogo-companion' ),
        ...
        $this->add_control(
            'ios_url',
            [
                'label' => esc_html__( 'IOS App URL', 'seogo-companion' ),
        ...
        $this->add_control(
            'android_url',
            [
                'label' => esc_html__( 'Android App URL', 'seogo-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default'   => [
                    'url' => '#'
    ...
    public function seogo_left_contents( $sec_title, $sec_text, $btn_label, $btn_url, $style_type ) {
    ...
    public function seogo_right_contents( $sec_img, $style_type ) {
    ...
    $ios_app_path = SEOGO_DIR_ICON_IMG_URI . 'ios-app.svg';
    $android_app_path = SEOGO_DIR_ICON_IMG_URI . 'android-app.svg';
    ?>
    
    <!-- productivity_area  -->
    <div class="productivity_area" <?php echo seogo_inline_bg_img( esc_url( $sec_img ) ); ?>>
        <div class="container">
