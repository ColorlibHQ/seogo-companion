...
/**
 *
 * Seogo elementor parctice area widget.
 *
 * @since 1.0
 */
class Seogo_Practice_Area extends Widget_Base {

	public function get_name() {
		return 'seogo-practice-area';
	}

	public function get_title() {
		return __( 'Practice Area', 'seogo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Practice Area content', 'seogo-companion' ),
			]
        );
        ...
        $this->add_control(
            'big_title',
            [
                'label' => esc_html__( 'Big Title', 'seogo-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Practice Area', 'seogo-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Practice Items', 'seogo-companion' ),
		...
		$this->add_control(
            'practice_items', [
                ...
                'fields' => [
                    [
                        'name' => 'item_bg_img',
                        'label' => __( 'Item BG Image', 'seogo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Item Icon', 'seogo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Item Title', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Business Law', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Item Text', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                    ...
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Anchor Text', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                    ...
                    [
                        'name' => 'btn_url',
                        'label' => __( 'Anchor URL', 'seogo-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [     
                        ...
                        'item_title' => __( 'Business Law', 'seogo-companion' ),
                    ...
                    [     
                        ...
                        'item_title' => __( 'Finance Law', 'seogo-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Family Law', 'seogo-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Education Law', 'seogo-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
     ...
     */
        ...
        $this->add_control(
            'sec_bg_col', [
                'label' => __( 'Section Bg Color', 'seogo-companion' ),
        ...
        $this->add_control(
            'sec_mid_bg_col', [
                'label' => __( 'Middle Section Bg Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Single Service Item Styles', 'seogo-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Icon Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_col', [
                'label' => __( 'Button Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Button Hover Styles', 'seogo-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
            ...
            <div class="row no-gutters">
                ...
                if( is_array( $practice_items ) && count( $practice_items ) > 0 ) {
                    foreach( $practice_items as $item ) {
                        ...
                        $item_bg_img  = !empty( $item['item_bg_img']['id'] ) ? wp_get_attachment_image( $item['item_bg_img']['id'], 'seogo_practice_thumb_448x500', '', array('alt' => $item_title . ' image' ) ) : '';
