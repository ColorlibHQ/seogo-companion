...
/**
 *
 * Seogo Pricing Table Contents section widget.
 *
 * @since 1.0
 */
class Seogo_Pricing_Contents extends Widget_Base {

	public function get_name() {
		return 'seogo-pricing-contents';
	}

	public function get_title() {
		return __( 'Pricing Contents', 'seogo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'pricing_content',
			[
				'label' => __( 'Pricing Contents', 'seogo-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => __( 'Unlock full Power', 'seogo-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'pricing', [
                ...
                'fields' => [
                    [
                        'name' => 'pack_name',
                        'label' => __( 'Package Name', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Basic', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'pack_price',
                        'label' => __( 'Package Price', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '$06', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'fet_1',
                        'label' => __( 'Feature 1', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'One User', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'fet_2',
                        'label' => __( 'Feature 2', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '1000 ui elements', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'fet_3',
                        'label' => __( 'Feature 3', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Webmail Support', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'fet_4',
                        'label' => __( 'Feature 4', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( '100GB Cloud Storage', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'fet_5',
                        'label' => __( 'Feature 5', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Unlimited Users Limit', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'btn_label',
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Get Now', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                ...
                'default'   => [
                    [
                        'pack_name'       => __( 'Basic', 'seogo-companion' ),
                        'pack_price'      => __( '$06', 'seogo-companion' ),
                        'fet_1'           => __( 'One User', 'seogo-companion' ),
                        'fet_2'           => __( '1000 ui elements', 'seogo-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'seogo-companion' ),
                        'fet_4'           => __( '100GB Cloud Storage', 'seogo-companion' ),
                        'fet_5'           => '',
                        'btn_label'       => __( 'Get Now', 'seogo-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
                        ],
                    ],
                    [
                        'pack_name'       => __( 'Team', 'seogo-companion' ),
                        'pack_price'      => __( '$16', 'seogo-companion' ),
                        'fet_1'           => __( '10 Users', 'seogo-companion' ),
                        'fet_2'           => __( '10000 ui elements', 'seogo-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'seogo-companion' ),
                        'fet_4'           => __( '1000GB Cloud Storage', 'seogo-companion' ),
                        'fet_5'           => __( 'Unlimited Users Limit', 'seogo-companion' ),
                        'btn_label'       => __( 'Get Now', 'seogo-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
                        ],
                    ...
                    [
                        'pack_name'       => __( 'Business', 'seogo-companion' ),
                        'pack_price'      => __( '$26', 'seogo-companion' ),
                        'fet_1'           => __( 'Unlimited User', 'seogo-companion' ),
                        'fet_2'           => __( '100000 ui elements', 'seogo-companion' ),
                        'fet_3'           => __( 'Webmail Support', 'seogo-companion' ),
                        'fet_4'           => __( '10000GB Cloud Storage', 'seogo-companion' ),
                        'fet_5'           => '',
                        'btn_label'       => __( 'Get Now', 'seogo-companion' ),
                        'btn_url'         => [
                            'url'         => '#'
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Client Section', 'seogo-companion' ),
        ...
        $this->add_control(
            'rev_desig_col', [
                'label' => __( 'Reviewer Designation Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
