...
/**
 *
 * Seogo elementor departments section widget.
 *
 * @since 1.0
 */
class Seogo_Departments extends Widget_Base {

	public function get_name() {
		return 'seogo-departments';
	}

	public function get_title() {
		return __( 'Departments', 'seogo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'seogo-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'seogo-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'seogo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'seogo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'seogo-companion' ),
                    ...
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'seogo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'seogo-companion' ),
                        'btn_text'   => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'seogo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'seogo-companion' ),
                        'btn_text'   => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'seogo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'seogo-companion' ),
                        'btn_text'   => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'seogo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'seogo-companion' ),
                        'btn_text'   => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'seogo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'seogo-companion' ),
                        'btn_text'   => __( 'Learn More', 'seogo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'seogo_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
