...
/**
 *
 * Seogo elementor faq section section widget.
 *
 * @since 1.0
 */
class Seogo_Faq_Section extends Widget_Base {

	public function get_name() {
		return 'seogo-faq-section';
	}

	public function get_title() {
		return __( 'Faq Section', 'seogo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'faq_contents',
			[
				'label' => __( 'Faq content', 'seogo-companion' ),
			]
        );
        ...
        $this->add_control(
            'sec_img',
            [
                'label' => esc_html__( 'Faq Image', 'seogo-companion' ),
                'description' => esc_html__( 'Best size is 490x480', 'seogo-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Faq Items', 'seogo-companion' ),
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Faq Title', 'seogo-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Frequently ask', 'seogo-companion' )
            ]
        );
		$this->add_control(
            'faq_items', [
                ...
                'fields' => [
                    [
                        'name' => 'faq_title',
                        'label' => __( 'Faq Title', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Adieus who direct esteem It esteems luckily?', 'seogo-companion' ),
                    ],
                    [
                        'name' => 'faq_text',
                        'label' => __( 'Faq Text', 'seogo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem esteems luckily or picture placing drawing.', 'seogo-companion' ),
                    ],
                ],
                'default'   => [
                    [      
     ...
     */
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Inner Styles', 'seogo-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'item_icon_col', [
                'label' => __( 'Item Icon Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_title_col', [
                'label' => __( 'Item Title Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'item_text_col', [
                'label' => __( 'Item Text Color', 'seogo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $sec_img = !empty( $settings['sec_img']['id'] ) ? wp_get_attachment_image( $settings['sec_img']['id'], 'seogo_accordion_thumb_490x480', '', array( 'alt' => $sec_title ) ) : '';
